...
alias al="taskset -c 7-9 env LD_PRELOAD=./build/libastraea_broker.so SLA=1250 ./build/localec_dpu"
alias am="taskset -c 10-12 env LD_PRELOAD=./build/libastraea_broker.so SLA=1250 ./build/memscan_dpu"


alias dc="taskset -c 1-3 ./build/cdn_dpu -r 50000"
alias dr="taskset -c 4-6 ./build/replica_dpu"
alias al="taskset -c 7-9 ./build/localec_dpu"
alias am="taskset -c 10-12 ./build/memscan_dpu"