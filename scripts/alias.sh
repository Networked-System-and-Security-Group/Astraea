...
alias ac="taskset -c 1 env LD_PRELOAD=./build/src/broker/libastraea_broker.so SLA=180 ./build/src/test/cdn_dpu/cdn_dpu"
alias ar="taskset -c 3-5 env LD_PRELOAD=./build/src/broker/libastraea_broker.so SLA=1860 ./build/src/test/replica_dpu/replica_dpu"
alias dc="taskset -c 1 ./build/src/test/cdn_dpu/cdn_dpu"
alias dr="taskset -c 3-5 ./build/src/test/replica_dpu/replica_dpu"
