...
alias ac="taskset -c 1-3 env LD_PRELOAD=./build/src/broker/libastraea_broker.so SLA=269 ./build/src/test/cdn_dpu/cdn_dpu -r 50000"
alias ar="taskset -c 4-6 env LD_PRELOAD=./build/src/broker/libastraea_broker.so SLA=1250 ./build/src/test/replica_dpu/replica_dpu"
alias dc="taskset -c 1-3 ./build/src/test/cdn_dpu/cdn_dpu -r 50000"
